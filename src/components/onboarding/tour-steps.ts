  ...
  },
  {
    ...
    animation: {
      ...
      commands: [
        ...
        { type: "move", to: "[data-tour='create-connection-btn']" },
        { type: "wait", ms: 300 },
        ...
        { type: "wait", ms: 1500 },
        { type: "tooltip-update", text: "Click 'Create Connection' to save." },
        { type: "move", to: "[data-slot='dialog-content'] button[type='submit']" },
        { type: "wait", ms: 800 },
        { type: "dialog-close" },
      ],
    },
  ...
  },
  {
    ...
    animation: {
      ...
      commands: [
        ...
        { type: "move", to: "[data-tour='create-template-btn']" },
        { type: "wait", ms: 300 },
        ...
        // Wrap up
        { type: "tooltip-update", text: "That's it! Click 'Create Template' to save." },
        { type: "move", to: "[data-slot='dialog-content'] button[type='submit']" },
        { type: "wait", ms: 800 },
        { type: "tooltip-update", text: "Your team can now select this template when creating approval requests." },
        { type: "wait", ms: 1500 },
        { type: "dialog-close" },
      ],
    },
